...
5.5. Quote each applied fix inline before the verdict (write, show, comment) per [`../../core/output/SKILL.md`](../../core/output/SKILL.md) Rule 7 — the Step 8 change table is the compressed-inspection-table form; for a small batch, show before/after per edit. Never report "fixed N issues" without the changed content.
