...
**Prompt.** *"Run `prompt-review` on `skills/prompt-engineer/agents/prompt-engineer.md`."*
...
**Prompt.** *"Review `skills/prompt-engineer/commands/prompt-optimize.md` and show the findings table."*
