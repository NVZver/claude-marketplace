...
([`../skills/implement/SKILL.md`](../implement/SKILL.md) + the five knowledge
...
2. **Run coverage is partial.** All 8 probe agents were dispatched and ran to
   ...
   the re-run. One transcript is not proof either way (`skills/lsa/CORE.md` §6: one pass is
...
sibling epic (or follow-up)**, which owns `skills/manager/implement/SKILL.md` and the
