...
- An agent's "done", its CHANGELOG line, its version-bump intent, and its roadmap delta are all **proposals** carried in the PR/payload, never edits to `CHANGELOG.md` / `plugin.json` / `roadmap.yaml`.
