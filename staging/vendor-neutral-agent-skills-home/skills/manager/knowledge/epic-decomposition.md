...
**Definition of done:** `skills/core/knowledge/new-plugin-checklist.md` exists with numbered items; each item names a file path to create. Manual walkthrough produces a scaffold that passes `lsa:verify`.
