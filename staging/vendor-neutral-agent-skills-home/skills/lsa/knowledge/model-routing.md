...
| 9 | prompt-engineer agent dispatches | `skills/prompt-engineer/agents/prompt-engineer.md` | — | inherit | A `sonnet` mechanical-scan route was reverted (kept at 0.8.3); re-add only if actually wired |
