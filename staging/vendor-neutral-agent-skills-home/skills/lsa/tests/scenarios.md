...
three reconcile prompt files (`skills/lsa/reconcile/SKILL.md`, `skills/lsa/CORE.md`,
`skills/lsa/knowledge/quality-gate-contract.md`); it is given the SETUP + PROBE
...
- **PASS CRITERIA:** Does **not** ask for the code to be reverted to the stale
  ...
  — the Level 2.5 absorb (`.lsa/constitution.md:144-156`); does not silently accept
