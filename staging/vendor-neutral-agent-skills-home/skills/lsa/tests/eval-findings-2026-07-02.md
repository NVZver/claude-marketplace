...
Sonnet agent whose ONLY guidance was `skills/lsa/reconcile/SKILL.md` +
`skills/lsa/CORE.md` + `skills/lsa/knowledge/quality-gate-contract.md`, then scored
...
`skills/lsa/reconcile/SKILL.md` right now; this epic changes no prompt files.
