...
| What | Action |
|------|--------|
| `skills/prompt-engineer/agents/prompt-engineer.md` | Create — agent moved from `.claude/agents/` |
| `skills/prompt-engineer/commands/prompt-review.md` | Create — command moved from `.claude/commands/` |
| `skills/prompt-engineer/commands/prompt-create.md` | Create — command moved from `.claude/commands/` |
| `skills/prompt-engineer/commands/prompt-optimize.md` | Create — command moved from `.claude/commands/` |
| `prompt-engineer/.claude-plugin/plugin.json` | Create — plugin manifest (v0.1.0) |
| `skills/prompt-engineer/CHANGELOG.md` | Create — initial entry |
| `skills/prompt-engineer/README.md` | Create — install instructions, command table |
