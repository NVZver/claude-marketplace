...
- `.claude-plugin/marketplace.json` (3 occurrences), root `README.md` (12), `CLAUDE.md` (2), `skills/core/README.md`, `helper/` cross-refs, `knowledge/index.md` (6), `scripts/lint.sh` (1).
...
- **Main components:**
  1. **Convention knowledge file** — write the `<actor>:<action>-<modifier> args` convention down as a citable rule (candidate: `skills/manager/knowledge/command-naming.md`) so future commands inherit it.
