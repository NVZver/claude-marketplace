...
2. **Mandatory constitution re-read per LSA skill.** The read protocol at
   `lsa/knowledge/conventions.md:31-35` makes `.lsa/constitution.md` (278 lines; 197 non-blank) a
...
| 9 | prompt-engineer agent dispatches | `skills/prompt-engineer/agents/prompt-engineer.md` | Per-command | sonnet for mechanical scan intents, inherit for authoring | Direct application of existing `code.md:53` |
