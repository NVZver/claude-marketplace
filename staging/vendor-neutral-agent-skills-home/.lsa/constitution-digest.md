> **Trace.** On load, print first: `=============== [.lsa/constitution-digest.md] [constitution] ===============`
<!-- GENERATED — DO NOT EDIT. Structural digest of .lsa/constitution.md built by scripts/build-constitution-digest.sh; regenerate with: bash scripts/build-constitution-digest.sh -->
<!-- source-sha256: 03c1475af917c7f59d13142a46fec89d6a866e1cf85d744da7fd06348b85e993 -->
...
## The two spine invariants (§1, verbatim)
...
## §2 First principles (titles, verbatim)
1. **Trust is the product.**
  - **1a. Ownership over automation.**
2. **Two groundings, always.**
  - **2a. Acceptance criteria are journey-shaped.**
3. **Ceremony scales to weight.**
4. **Knowledge is not Actor.**
