...
1. Read target files → categorized file list (actors vs knowledge per [knowledge/separation-of-concerns.md](../knowledge/separation-of-concerns.md))
2. Check separation of concerns per [knowledge/separation-of-concerns.md](../knowledge/separation-of-concerns.md) → boundary violation list
3. Check actors against [knowledge/actor-ground-rules.md](../knowledge/actor-ground-rules.md) rules 1-10 → actor findings
4. Check knowledge files against [knowledge/quality-checks.md](../knowledge/quality-checks.md): Knowledge File Quality Checks 1-6, KISS/DRY 1-5, AI Over-Engineering 1-5, Context Budget 1-4 → knowledge findings
5. Assign severity per [knowledge/quality-checks.md](../knowledge/quality-checks.md) Severity Levels table → all findings rated
6. Based on task:
