...
3. Check actors against [knowledge/actor-ground-rules.md](../knowledge/actor-ground-rules.md) rules 1-10 → actor findings. Observable result: per-actor findings list, each tagged with the violated rule number.
