...
- **Silence on no signal.** A signal-less cycle produces zero user-facing output — no marker, token, placeholder, status line, parenthetical, or narration (mirrors [`../observe/SKILL.md:51`](../observe/SKILL.md) step 8d) (F4).
