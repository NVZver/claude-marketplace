...
| F5 | **CHANGELOG check.** When a plugin has ≥1 staged file, the system shall require ≥1 staged added line in `<plugin>/CHANGELOG.md`; if absent it shall record a violation for that plugin. | Must |
