...
1. **Static grep predicates** — mechanical checks on the skill bodies post-sweep. Cheap, runnable in CI when a self-eval harness lands (deferred per `.lsa/roadmap.md:28`).
