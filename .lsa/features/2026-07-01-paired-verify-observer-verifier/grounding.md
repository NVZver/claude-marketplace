...
| "does" check (F6) | exists @ `lsa/skills/reconcile/SKILL.md:31` |
| "only" check (F7) | exists @ `lsa/skills/reconcile/SKILL.md:32` |
| "all" check deferred (F8) | exists @ `lsa/skills/reconcile/SKILL.md:33` (whole-plan completeness — correctly kept OUT of the per-increment grader) |
