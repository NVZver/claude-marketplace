...
**Plugin manifest:** [`manager/.claude-plugin/plugin.json`](../../../manager/.claude-plugin/plugin.json) (v0.9.0)
...
- **Versioning.** `manager` evolves with its own SemVer + CHANGELOG (`.lsa/VISION.md` §1 *"Distribution + versioning"*). Currently v0.9.0.
