...
**Plugin manifest:** [`lsa/.claude-plugin/plugin.json`](../../../lsa/.claude-plugin/plugin.json) (v0.28.0)
...
- **Versioning.** `lsa` evolves with its own SemVer + CHANGELOG. Currently v0.28.0.
