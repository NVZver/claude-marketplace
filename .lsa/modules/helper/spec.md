...
- **No conversation-state persistence.** Helper does not store per-user / per-session state beyond the active turn's cooldown derivation. Per `.lsa/features/2026-05-21-helper-agent/requirements.md:40`.
