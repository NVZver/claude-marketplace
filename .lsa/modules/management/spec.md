...
**Plugin manifest:** [`management/.claude-plugin/plugin.json`](../../../management/.claude-plugin/plugin.json) (v0.5.0)
...
- **Versioning.** `management` evolves with its own SemVer + CHANGELOG (`.lsa/VISION.md` §1 *"Distribution + versioning"*). Currently v0.5.0.
