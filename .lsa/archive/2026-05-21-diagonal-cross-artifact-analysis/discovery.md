...
## Source
- `.lsa/roadmap.md:64-75` — feature definition (Tech Picture adoption 2026-05-20, item #3).
- `lsa/skills/lsa-specify/SKILL.md:154` — current Gate 2 behavior (AC→Journey coverage only).
- `.lsa/plans/2026-05-20-credo-rollout-plan.md:243-246` — seed sample of AC→Journey check pattern.
