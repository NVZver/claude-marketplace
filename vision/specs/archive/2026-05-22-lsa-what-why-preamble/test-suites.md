...
| 3 | Consequence predicate | Each preamble contains a clause naming the consequence — e.g., "without …", "merging now would …", "rejecting leaves …". Roadmap row's gold reference (`vision/specs/roadmap.md:125`). |
