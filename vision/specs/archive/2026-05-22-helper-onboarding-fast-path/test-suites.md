> **Trace.** On load, print first: `=============== [vision/specs/features/2026-05-22-helper-onboarding-fast-path/test-suites.md] [vision] ===============`

# Test Suites: Helper fast-path for onboarding questions

> Source: `vision/specs/roadmap.md` §"2026-05-22 backlog detail" #2. Requirements: `./requirements.md`. Design: `./design.md`.

## Verification approach

Every Journey below is a **manual probe** run in a fresh Claude Code session (Helper-style — `helper/README.md:42-57` calls these *"V1 / V2 / V3 probes"*). Each Journey covers one or more ACs from `requirements.md`. The probes follow the V1 → V2 → V3 progression in `vision/specs/standards/testing.md` (cited via `helper/README.md:57`).
...
**Goal:** prove the roadmap row's primary failure mode is fixed (`vision/specs/roadmap.md:113` — *"~3 minutes (user-reported, 2026-05-22)"* → ≤5s).
...
- Path 4: ≤5s, quote from `README.md:1-12` + `vision/VISION.md:13-15`.
