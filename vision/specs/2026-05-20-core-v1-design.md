...
| Spec location | `vision/specs/YYYY-MM-DD-*.md` | repo-root `docs/superpowers/specs/…` |
...
1. **What's here.** Two skills, one sentence each. Pointer to `vision/VISION.md` for the "why".
