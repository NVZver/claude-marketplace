...
Additional top-level directories (`hooks/`, `commands/`, `tests/`, `ARCHITECTURE.md`, `VERIFICATION.md`) are added as needed. Source: `vision/specs/archive/2026-05-20-core-v1/design.md` §3.
...
The configured constitution for this repo (per `/.lsa.yaml: constitution`) is `vision/VISION.md`, not `/CLAUDE.md`. `/CLAUDE.md` is the slimmed Claude Code entry point — it points at the constitution but is not the constitution.
