...
Verification is a mix of mechanical re-grep and human roleplay — there is no compiled artifact to test. Per `vision/VISION.md` §2 sub-principle 2a, every journey is user-observable at the user/system boundary.
...
**Goal:** The dominant user-visible failure mode from `vision/specs/roadmap.md:119` no longer reproduces.
**Covers:** AC2.
...
| # | Path | Actions |
|---|------|---------|
| 1 | Document read | Read `core/skills/output/SKILL.md` Rule 5 after PR-A merges. Confirm the new sub-rule names the orthogonality to `vision/VISION.md:66` Principle 9. |
